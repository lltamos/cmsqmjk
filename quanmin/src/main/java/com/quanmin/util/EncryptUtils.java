...
public class EncryptUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // des加密测试
        String enCode = desEncrypt("abc");
        System.out.println(enCode);
        String deCode = desDecrypt(enCode);
        System.out.println(deCode);

        // aes加密
        String aesEncrypt = aesEncrypt("abc", "abcd");
        System.out.println(aesEncrypt);
        String aesDecrypt = aesDecrypt(aesEncrypt, "abcd");
    ...
    public static String desEncrypt(String str) {
        String fKey = "qmjkdev";/* 必需的密钥 */
        String sKey = "heasy";
        String tKey = "1.0";
        String strs = strEncode(str, fKey, sKey, tKey);
        try {
            return new BASE64Encoder().encode(strs.getBytes("utf-8"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String desDecrypt(String str) {
        ...
        String tKey = "1.0";
        try {
            String strDecode = strDecode(new String(new BASE64Decoder().decodeBuffer(str), "utf-8"), fKey, sKey, tKey);
            return strDecode;
        } catch (IOException e) {
            e.printStackTrace();
        }
