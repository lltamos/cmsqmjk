...
public final class Commons {
    ...
    public static String SMS_CODE_EXPIRED_CODE="528";
    public static String SMS_CODE_EXPRIED_STR="验证码过期";

    public static String SMS_CODE_PHONE_CODE="530";
    public static String SMS_CODE_PHONE_STR="手机号码不正确";


    public static String SMS_CODE_RECOMMEND_STR="用户已经存在";
    public static String SMS_CODE_RECOMMEND_CODE="700";
    ...
    public static final String YIHU_HOST="yihuyishen_host";

    public static String YIHUYISHEN_TOKEN="";
    ...
    //jedis 订单编号后五位
    public static final String REDIS_KEY_ORDERNUMBER="REDIS_KEY_ORDERNUMBER";
