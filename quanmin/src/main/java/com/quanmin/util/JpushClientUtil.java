...
public class JpushClientUtil {
    ...
    private final static String appKey = "1f5242824e09adb552aa893a";
 
    private final static String masterSecret = "83759b843f2fd6fbabc9844f";
    ...
    public static void main(String[] args){
        if(JpushClientUtil.sendToRegistrationId("1507bfd3f7f72e8cf5d","通知内容标题", "消息内容标题", "消息内容", "扩展字段")==1){
